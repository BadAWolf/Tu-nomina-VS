...
El finiquito usa únicamente categoría, jornada, responsable, fechas, vacaciones, prorrateo, causa de extinción e IRPF. Se han eliminado el bloque de casos especiales y todos sus campos, sin trasladarlos a otra sección. Supone abonadas las extras el día 15 de marzo, julio y diciembre (art. 45); Navidad no se suma otra vez, y las altas posteriores conservan su devengo. La antigüedad se obtiene del inicio, con quinquenios desde 1997; los trienios anteriores se identifican como fuera del alcance automático. Para arma y funciones de escolta/responsable se muestran referencias con funciones estables, sin inferir historiales reales. No incluye sueldo del último mes, otros pluses variables, impagos ni anticipos. Las cotizaciones de vacaciones y el IRPF de la indemnización por despido que no se pueden determinar se identifican como pendientes; el fin temporal sí lleva el IRPF indicado. Pantalla y PDF comparten estos supuestos.

La IT requiere siempre la base real de cotización o la base diaria reconocida. Se ha eliminado la opción de estimar la prestación desde las tablas; estas se conservan para el complemento por accidente laboral. Las excepciones de cotización siguen plegadas y se mantienen las diferencias entre salario mensual, diario y tiempo parcial. `tests/simplified-forms.test.cjs` verifica vencimientos, nuevos contratos en diciembre, saldos, datos imprescindibles y coherencia del PDF.
