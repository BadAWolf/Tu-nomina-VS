...
El finiquito ordinario usa las fechas y las pagas prorrateadas: supone abonadas las extras el día 15 de marzo, julio y diciembre (art. 45). Navidad no se suma de nuevo si la persona ya estaba contratada el día del pago; quienes empiezan después conservan su devengo proporcional. «Solo si tu caso es especial», cerrado inicialmente, conserva subrogación, retribución real, saldos pendientes y deducciones reconocidas. Los saldos indicados de extras ya excluyen lo cobrado y sustituyen la estimación; no se vuelven a descontar pagos. No se presumen deudas por anticipos ni un neto completo cuando faltan las cuotas L13 o los requisitos fiscales.
